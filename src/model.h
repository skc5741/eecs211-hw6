...
public:
    ...
    // vvv DON'T REMOVE THIS LINE, OR THE GRADER WON'T COMPILE vvv
    friend struct Test_access;
    // ^^^ DON'T REMOVE THIS LINE, OR THE GRADER WON'T COMPILE ^^^
...
private:
    ...
    /// *********************************************
    ///
    /// You may add or change anything you like below this line.
    ///
