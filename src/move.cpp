...
size_t Position_set::index_of_(Position_set::value_type p)
{
...
std::ostream& std::operator<<(std::ostream& os, Move const& move)
{
    os << "Move{{" << move.first.x << ", " << move.first.y << "}, {";

    bool first = true;
    for (ge211::Position pos : move.second) {
